  ...
  return (
    <>
      <header className="px-12 py-8">
        <div className="logo">
          <Link to="/">
            <img src="/assets/2.png" width={120} alt="" />
          </Link>
        </div>
      </header>
      <div className="bg-[#d2f9d1] py-10 w-full">
        <div className="bg-green-300 py-10 text-center w-1/2 mx-auto">
          <h1 className="text-5xl my-12 font-semibold">Log in to music app</h1>
